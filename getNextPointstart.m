...
function [x, dist, dir, searchPoints] = getNextPointstart(searchPoints, xorig,x0, dir0, X, Y, MAXDIST, MAXANGLE, MAXDIST2LINE, doshow)
    ...
    [ix_n, d] = getClosestNeighbours(searchPoints(:, ix_l), x0, 32);
